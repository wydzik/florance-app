...
urlpatterns = [
    ...
    path("password-reset/", auth_views.PasswordResetView.as_view(template_name="auth/password_reset.html",html_email_template_name="registration/password_reset_email.html", subject_template_name="registration/password_reset_subject.txt", success_url=reverse_lazy("password_reset_done")), name="password_reset"),
    ...
    path("realizacja/<int:plik_id>/update-plik-visibility/", views.update_plik_visibility, name="update_plik_visibility")
